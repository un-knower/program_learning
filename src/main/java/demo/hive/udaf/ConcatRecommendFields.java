...
public class ConcatRecommendFields extends UDAF {
  public static class ConcatFieldsEvaluator implements UDAFEvaluator {
    ...
    public boolean iterate(String vid, String title, String imgpath, String is_rcc, String is_share,
        String is_collect, String is_uninterested, String is_tie, String deli) {
      String value = "{\"vid\":\"" + vid + "\",\"title\":\"" + title + "\",\"imgpath\":\"" + imgpath
          + "\",\"is_rcc\":" + is_rcc + ",\"is_share\":" + is_share + ",\"is_collect\":"
          + is_collect + ",\"is_uninterested\":" + is_uninterested + ",\"is_tie\":" + is_tie + "}";
      if (partial == null) {
