...
//        prop.load( ProduceUserData.class.getClassLoader().getResourceAsStream("producer.properties") );
        prop.put("zookeeper.connect", "SparkMaster:2181,SparkWorker1:2181,SparkWorker2:2181");
        prop.put("serializer.class", StringEncoder.class.getName());
        prop.put("metadata.broker.list", "SparkMaster:9092");
        //自定义分区
        prop.put("partitioner.class", "kafka.demo2.MyPartition");
        ...
        while ( true ){
            ...
            //System.out.println(visData);
            //根据userId作为一个Key分区用
            list.add( new KeyedMessage<String, String>( topic ,String.valueOf(userIndex) , visData ) );
