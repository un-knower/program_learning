...
public class SingleColumnValueExcludeFilterDemo {
  ...
  public void testSingColumnValueExcludeFilter(Configuration conf) {
    try {
      ...
      Filter filter = new SingleColumnValueExcludeFilter(familyName, columnName2, CompareOp.EQUAL, new BinaryComparator("87".getBytes()));
      Scan scan = new Scan();
...
//      
  ...
  public static void main(String[] args) {
    SingleColumnValueExcludeFilterDemo demo = new SingleColumnValueExcludeFilterDemo();
