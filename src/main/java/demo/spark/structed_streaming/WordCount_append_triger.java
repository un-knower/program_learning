...
在Structured Streaming 里，多出了outputMode,现在有complete,append,update 三种，现在的版本只实现了前面两种。
 ...
 */
public class WordCount_append_triger {
    public static void main(String args[]) throws StreamingQueryException {
        ...
        StreamingQuery query = words.writeStream().trigger(Trigger.ProcessingTime("10 seconds"))
                .outputMode("append")
                .format("console")
                .start();
