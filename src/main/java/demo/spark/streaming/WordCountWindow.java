...
public class WordCountWindow {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        JavaPairDStream<String, Integer> wordSplit = dataSource.map(new Function<String, String>() {
            @Override
...
//        }, Durations.seconds(20), Durations.seconds(20));
        ...
        JavaPairDStream<String, Integer> window2 = wordSplit.reduceByKeyAndWindow(new Function2<Integer, Integer, Integer>() {
            @Override
            public Integer call(Integer num1, Integer num2) throws Exception {
                return num1 + num2;
            }
        }, Durations.seconds(9), Durations.seconds(2));


//        window1.print();

        window2.print();
//        window2.foreachRDD(new VoidFunction<JavaPairRDD<String, Integer>>() {
//            @Override
